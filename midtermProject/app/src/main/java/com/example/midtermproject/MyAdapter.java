...
public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //final LinearLayout buttonTap =(LinearLayout)((Activity)mMain).findViewById(R.id.buyingTap);
        ...
        cmdArea.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {//리스트클릭시 이벤트
    ...
    public void addItem(int img, String name, String contents,int price) {
